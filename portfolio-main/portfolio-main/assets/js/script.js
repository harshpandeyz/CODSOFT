...
const certificationBoxes = document.querySelectorAll('.certifications .box');

certificationBoxes.forEach((box, index) => {
    box.style.opacity = 0;
    ...
    }, index * 200); // Staggered animation with 200ms delay between each box
});



/* ===== CERTIFICATIONS ANIMATION ===== */
const certificationContainer = document.querySelector('.certifications .box-container');
const certifications = [
    {
        title: "Certification 1",
        description: "Description for certification 1",
        image: "assets/images/certifications/cert1.png",
        link: "https://example.com/cert1"
    },
    {
        title: "Certification 2",
        description: "Description for certification 2",
        image: "assets/images/certifications/cert2.png",
        link: "https://example.com/cert2"
    },
    {
        title: "Certification 3",
        description: "Description for certification 3",
        image: "assets/images/certifications/cert3.png",
